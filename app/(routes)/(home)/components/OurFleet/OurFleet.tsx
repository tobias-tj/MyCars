...
export function OurFleet() {
  return (
    <div className="max-w-6xl mx-auto text-center py-12 lg:py-40 p-6">
      ...
      <p className="text-lg mt-2 lg:mt-5 lg:text-xl text-center w-full mx-auto max-w-2xl">
        Experience the thrill of driving the world's finest cars. Discover
        unmatched luxury and performance, right here in Paraguay, at a price
        you'll love.
      </p>
      <div className="grid grid-cols-2 lg:grid-cols-6 gap-4 items-center justify-center mb-5 max-w-2xl mx-auto mt-5">
      ...
      <div className="mb-10">
        ...
        <div className="flex justify-center">
          <Link href="/cars">
            <Button
              className="rounded-xl p-6 text-lg mt-5 flex items-center justify-center"
              variant="outline"
            >
